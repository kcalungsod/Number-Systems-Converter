...
namespace NumberSystemsConverter
{
	partial class Octal
	{
		...
		private void InitializeComponent()
		{
			...
			this.label3.Text = "Input an octal number. You can only input digits from 0 to 7.";
			// 
			// btn_convert
			// 
			this.btn_convert.Location = new System.Drawing.Point(195, 50);
			...
			// btn_clear
			// 
			this.btn_clear.Location = new System.Drawing.Point(199, 201);
			...
			// btn_back
			// 
			this.btn_back.Location = new System.Drawing.Point(297, 201);
			...
			this.groupBox1.Text = "From Octal to:";
			// 
			// rbtn_hexadecimal
			// 
